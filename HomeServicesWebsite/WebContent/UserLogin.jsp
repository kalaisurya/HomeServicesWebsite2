...
<form  name = "frm"method="post" action="UserLoginController" onSubmit="return ValidateEmail()">
</br>
...
<tr>
<td><br/><center><input  type="submit" name = "Submit" value="Submit" class="btn btn-info" /></center></td>
</tr>
</form>
</table>
</center>
