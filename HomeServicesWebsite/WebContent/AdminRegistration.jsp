...
<form  name = "frm"method="post" action="AddAdminController" onSubmit="return ValidateEmail()">
...
<tr>
<td><br/><center><input  type="submit" name="Submit"  value="ADD ADMIN"class="btn btn-info" /></center></td>
</tr>
</form>
</table>
</center>
